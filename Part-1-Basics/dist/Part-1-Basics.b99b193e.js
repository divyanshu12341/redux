...
})({"9RAVF":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "1048852eb99b193e";
"use strict";
...
},{}],"fZPs4":[function(require,module,exports,__globalThis) {
...
// reduxState = reducer(reduxState, { type: "incrementBy", payload: 10 });
const devToolsEnhancer = typeof window !== "undefined" && window.__REDUX_DEVTOOLS_EXTENSION__?.();
const store = (0, _redux.legacy_createStore)(reducer, devToolsEnhancer);
store.subscribe(()=>{
...
},{}]},["9RAVF","fZPs4"], "fZPs4", "parcelRequiref2b6", {})

//# sourceMappingURL=Part-1-Basics.b99b193e.js.map
